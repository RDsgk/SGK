(function() {
  ...
  jQuery(function($) {
    ...
    loadNews = function() {
      ...
      $("#product-news-header").before('<a style="float: right; background-image:none;' + ' padding-right: 16px; cursor: pointer;" class="showhide"' + ' href="#">' + currTitle + '</a>');
      $('a.showhide').prepend('<img alt="Newspaper" ' + ' src="/assets/icons/silky/newspaper.png" style="margin-bottom: -3px; ' + ' margin-right: 3px;">').click(toggleNewsPane);
      if (newsHidden) {
        $("#product-news").hide();
