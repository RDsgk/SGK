(function() {
  ...
  window.Forms = {
    ...
    renderHelpLinks: function(scope) {
      ...
      $('a.help', scope).mouseover(function() {
        return $(this).find('img').attr('src', '/assets/icons/silky/information_hover.png');
      });
      return $('a.help', scope).mouseout(function() {
        return $(this).find('img').attr('src', '/assets/icons/silky/information.png');
      });
    }
  };
  ...
  $(document).ready(function() {
    $('a#advanced-options').live('click', function(e) {
